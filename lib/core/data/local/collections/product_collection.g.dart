...
void _productCollectionSerialize(
  ...
  writer.writeDouble(offsets[1], object.defaultTaxRate);
  writer.writeString(offsets[2], object.description);
  writer.writeString(offsets[3], object.name);
  writer.writeDouble(offsets[4], object.price);
  writer.writeString(offsets[5], object.unitType);
...
ProductCollection _productCollectionDeserialize(
  ...
  object.defaultTaxRate = reader.readDoubleOrNull(offsets[1]);
  object.description = reader.readStringOrNull(offsets[2]);
  object.id = id;
  object.name = reader.readString(offsets[3]);
  object.price = reader.readDouble(offsets[4]);
  object.unitType = reader.readString(offsets[5]);
...
extension ProductCollectionQueryProperty
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> unitTypeProperty() {
    return QueryBuilder.apply(this, (query) {
