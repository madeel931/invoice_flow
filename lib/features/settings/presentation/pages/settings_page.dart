                          ...
                          child: Column(
                            children: [
                              GlobalTextField(
                                  ...
                                  maxLength: 80,
                                  validator: (val) => AppValidators.requiredText(val, min: 2, max: 80, fieldName: 'Business Name', errorRequired: AppLocalizations.of(context)?.businessNameRequired)),
                              const SizedBox(height: AppSpacing.md),
                              GlobalTextField(
                          ...
                          child: Column(
                            children: [
                              ...
                              GlobalTextField(
                                  ...
                                  validator: (val) => AppValidators.phone(val, max: 30,
