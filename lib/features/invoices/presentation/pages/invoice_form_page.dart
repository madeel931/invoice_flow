                      ...
                      children: [
                        Autocomplete<Customer>(
                          ...
                          optionsBuilder: (TextEditingValue textEditingValue) {
                            ...
                            return availableCustomers.where((Customer option) {
                          ...
                          child: ListTile(
                            title: Text(item.description,
                                style: const TextStyle(
                                    fontWeight: FontWeight.bold)),
                            subtitle: Text(
                                '${item.quantity} x ${item.unitPrice.toStringAsFixed(2)}   (Tax: ${item.taxRate}%)'),
                    ...
                    child: Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          onChanged: (val) =>
                              context.read<InvoiceFormCubit>().updateNotes(val),
                        ),
                      ],
                    ),
                  ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                    text: 'Save as Draft',
                    isLoading: invoiceState.status == InvoiceFormStatus.saving,
