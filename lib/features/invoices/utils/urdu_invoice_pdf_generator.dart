...
class UrduInvoicePdfGenerator {
  static String _getPdfStatusString(InvoiceStatus status) {
    switch (status) {
      case InvoiceStatus.draft: return PdfTextFormatter.formatUserTextForPdf('مسودہ');
      case InvoiceStatus.unpaid: return PdfTextFormatter.formatUserTextForPdf('غیر ادا شدہ');
      case InvoiceStatus.partiallyPaid: return PdfTextFormatter.formatUserTextForPdf('جزوی ادا شدہ');
      case InvoiceStatus.paid: return PdfTextFormatter.formatUserTextForPdf('ادا شدہ');
      case InvoiceStatus.overdue: return PdfTextFormatter.formatUserTextForPdf('زائد المیعاد');
      case InvoiceStatus.cancelled: return PdfTextFormatter.formatUserTextForPdf('منسوخ');
    }
  }
          ...
          return [
            ...
            pw.Row(
              ...
              children: [
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text(PdfTextFormatter.formatUserTextForPdf('انوائس'),
                        style: pw.TextStyle(
                            fontSize: 32,
                            fontWeight: pw.FontWeight.bold,
                    ...
                    pw.Text(
                        '${dateFormat.format(invoice.issueDate)} :${PdfTextFormatter.formatUserTextForPdf('تاریخ اجرا')}',
                        style: const pw.TextStyle(color: PdfColors.grey700)),
                    pw.Text('${dateFormat.format(invoice.dueDate)} :${PdfTextFormatter.formatUserTextForPdf('مقررہ تاریخ')}',
                        style: const pw.TextStyle(color: PdfColors.grey700)),
                    pw.SizedBox(height: 4),
                    pw.Text('${_getPdfStatusString(invoice.effectiveStatus)} :${PdfTextFormatter.formatUserTextForPdf('حیثیت')}',
                        style: pw.TextStyle(
                          fontWeight: pw.FontWeight.bold,
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      if (profile.taxId != null && profile.taxId!.isNotEmpty)
                        pw.Text('${profile.taxId} :${PdfTextFormatter.formatUserTextForPdf('ٹیکس آئی ڈی')}',
                            style: const pw.TextStyle(color: PdfColors.grey700)),
            ...
            pw.Container(
              ...
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.end,
                children: [
                  pw.Text(PdfTextFormatter.formatUserTextForPdf('بل بنام:'),
                      style: pw.TextStyle(
            ...
            pw.Table(
              ...
              children: [
                ...
                pw.TableRow(
                  ...
                  children: [
                    _tableHeaderCell(PdfTextFormatter.formatUserTextForPdf('کل رقم'), pw.Alignment.centerLeft),
                    _tableHeaderCell(PdfTextFormatter.formatUserTextForPdf('ٹیکس'), pw.Alignment.center),
                    _tableHeaderCell(PdfTextFormatter.formatUserTextForPdf('قیمت فی اکائی'), pw.Alignment.centerLeft),
                    _tableHeaderCell(PdfTextFormatter.formatUserTextForPdf('مقدار'), pw.Alignment.center),
                    _tableHeaderCell(PdfTextFormatter.formatUserTextForPdf('تفصیل'), pw.Alignment.centerRight),
                  ],
                ),
                // Data rows
                if (calc.itemBreakdowns.isEmpty)
                  pw.TableRow(
                    children: [
                      ...
                      _tableBodyCell('-', pw.Alignment.centerLeft),
                      _tableBodyCell('-', pw.Alignment.center),
                      _tableBodyCell(PdfTextFormatter.formatUserTextForPdf('کوئی آئٹم شامل نہیں کیا گیا'), pw.Alignment.centerRight),
                    ]
                  )
                else
                      ...
                      children: [
                        pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text(PdfTextFormatter.formatUserTextForPdf('ذیلی کل:'),
                          ...
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Text(invoice.discountType == 'percentage' 
                                  ? PdfTextFormatter.formatUserTextForPdf('رعایت (${invoice.discountAmount}%):') 
                                  : PdfTextFormatter.formatUserTextForPdf('رعایت:'),
                                  style: const pw.TextStyle(
                                      color: PdfColors.red700)),
                            ],
                          ),
                        ...
                        pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text(PdfTextFormatter.formatUserTextForPdf('ٹیکس:'),
                                style: const pw.TextStyle(
                                    color: PdfColors.grey700)),
                          ],
                        ),
                        ...
                        pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text(PdfTextFormatter.formatUserTextForPdf('مجموعی رقم:'),
                                style: pw.TextStyle(
                                    fontWeight: pw.FontWeight.bold,
                                    fontSize: 14)),
                          ],
                        ...
                        if (calc.paidAmount > 0) ...[
                          ...
                          pw.Row(
                            ...
                            children: [
                              ...
                              pw.Text(PdfTextFormatter.formatUserTextForPdf('ادا شدہ رقم:'),
                                  style: const pw.TextStyle(
                                      color: PdfColors.grey700)),
                            ],
                          ),
                        ...
                        pw.Row(
                          ...
                          children: [
                            ...
                            pw.Text(PdfTextFormatter.formatUserTextForPdf('بقایا رقم:'),
                                style: pw.TextStyle(
                                    fontWeight: pw.FontWeight.bold,
            ...
            if (invoice.notes != null && invoice.notes!.isNotEmpty) ...[
              pw.Container(
                alignment: pw.Alignment.centerRight,
                child: pw.Text(PdfTextFormatter.formatUserTextForPdf('نوٹس / ادائیگی کی شرائط:'),
                    style: pw.TextStyle(
                        fontWeight: pw.FontWeight.bold,
                        color: PdfColors.grey700)),
              ),
